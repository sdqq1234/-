...
public class AyaSubShooter : MonoBehaviour {

	// Use this for initialization
    //void Start () {
    //    base.Start();
    //    //string AyaSubBulletName = "AyaSubBullet";
    //    //bulletNameList.Add(AyaSubBulletName);
    //    bulletNameList.Add(obj_OwnBulletTypeList[0].name);
    //    setBulletSortingLayer(CommandString.MyBulletLayer);
    //    hitEnable = false;
    //    //dir_Bullets = AyaSubBulletDir;
    //    //pos_Bullets = AyaSubBulletPos;
    //}
